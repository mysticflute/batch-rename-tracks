...
// TODO: verbose mode which outputs more info, like disk number.
// TODO: work on a top-level ost directory and find all disk numbers.
 ...
 * @see extensions.
 */
const rename = function (config, dir, options) {
  if (!dir) {
